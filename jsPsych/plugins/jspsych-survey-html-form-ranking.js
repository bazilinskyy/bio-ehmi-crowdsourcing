    ...
    if(trial.unique_values){
      for (var row = 0; row < trial.rows; row++) { // iterate over rows
        for (var item = 0; item < trial.items_per_row; item++) {  // iterate over items in each row
          console.log('#jspsych-ranking-input-' + row + '-' + item);
          console.log(display_element.querySelector('#jspsych-ranking-input-' + row + '-' + item));
          console.log(display_element.querySelector('#jspsych-ranking-input-' + row + '-' + item));
          display_element.querySelector('#jspsych-ranking-input-' + row + '-' + item).addEventListener('input', function(){
            rankings_given[row][item] = display_element.querySelector('#jspsych-ranking-input-' + row + '-' + item).value;
